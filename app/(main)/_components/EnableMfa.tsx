...
import { mfaSetupQueryn, mfaType, verifyMFAMutationFn } from "@/lib/api";
import { Skeleton } from "@/components/ui/skeleton";
import { toast } from "@/hooks/use-toast";
import RevokeMfa from "./common/RevokeMfa";
                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    <Button disabled={isPending} className="w-full h-[40px]">
                      {" "}
                      {isPending && <Loader className="animate-spin" />} Verify
                    </Button>
                  </form>
                </Form>
              </div>
